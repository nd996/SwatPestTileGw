...
!!    arrays which contain data related to HRU output 
      ...
      !hendrik 1/2017
      !hendrik 1/2017
      allocate (hrupsta(mpst,7,mhru))
      allocate (hrupstd(mpst,7,mhru))
      allocate (hrupstm(mpst,7,mhru))
      allocate (hrupsty(mpst,7,mhru))
      !hendrik 1/2017
...
!!    arrays
   ...
   !   allocate (hhprecip(24))
      ...
      !hendrik 1/2017
      allocate (wpstaao(mpst,7))
      allocate (wpstmono(mpst,7))
      allocate (wpstyro(mpst,7))
      allocate (wpstdayo(mpst,7))
      !hendrik 1/2017
