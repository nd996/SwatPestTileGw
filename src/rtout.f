...
!!    ~ ~ ~ ~ ~ ~ END SPECIFICATIONS ~ ~ ~ ~ ~ ~
      ...
      integer :: jrch, ii
      real*8 :: sedcon, bedvol, sedpest, wtmp, chpstmass
...
!! set subdaily reach output    - by jaehak jeong for urban project, subdaily output in output.rch file
	if (ievent==1.and.iprint==3) then
     ...
     &      / (idt * 60.)		       
          ...
          rchhr(26,jrch,ii) = hhvaroute(11,inum2,ii) * (1. - rnum1)  !!solpst in (mg pst) !HR added Oct 2019
          rchhr(27,jrch,ii) = hhvaroute(11,ihout,ii)                 !!solpst out (mg pst) !HR added Oct 2019
          rchhr(28,jrch,ii) = hhvaroute(12,inum2,ii) * (1. - rnum1)  !!srbpst in (mg pst) !HR added Oct 2019
          rchhr(29,jrch,ii) = hhvaroute(12,ihout,ii)                 !!srbpst out (mg pst) !HR added Oct 2019
	  end do
	endif
...
!!MW, 2/24/2020: determine amount pesticide stored in water column 
      chpstmass = chpst_conc(jrch) * rchstor(jrch) !!water column mass in mg
...
!! set daily reach output
      ...
      rchdy(38,jrch) = chpstmass                         !!pst in water column ... modified from 'persistent bact out'
      rchdy(39,jrch) = rchstor(jrch)                     !!water stored in reach (m3) at end of timestep (replaced from 'persistent bact out')
